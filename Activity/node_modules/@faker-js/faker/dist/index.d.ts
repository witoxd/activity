import { F as Faker, L as LocaleDefinition, R as Randomizer } from '@faker-js/faker/dist/airline-BLb3y-7w';
export { r as Aircraft, s as AircraftType, A as AirlineDefinition, t as AirlineModule, a as AnimalDefinition, u as AnimalModule, $ as BitcoinAddressFamily, a1 as BitcoinAddressFamilyType, a0 as BitcoinNetwork, a2 as BitcoinNetworkType, B as BookDefinition, v as BookModule, y as Casing, ak as ChemicalElement, C as ColorDefinition, z as ColorFormat, E as ColorModule, b as CommerceDefinition, O as CommerceModule, c as CommerceProductNameDefinition, d as CompanyDefinition, Q as CompanyModule, w as CssFunction, G as CssFunctionType, x as CssSpace, J as CssSpaceType, Z as Currency, D as DatabaseDefinition, T as DatabaseModule, U as DatatypeModule, e as DateDefinition, f as DateEntryDefinition, X as DateModule, q as FakerOptions, g as FinanceDefinition, _ as FinanceModule, h as FoodDefinition, a3 as FoodModule, a4 as GitModule, H as HackerDefinition, a5 as HackerModule, a6 as HelpersModule, a9 as IPv4Network, aa as IPv4NetworkType, a8 as ImageModule, I as InternetDefinition, ab as InternetModule, i as LocaleEntry, j as LocationDefinition, ac as LocationModule, k as LoremDefinition, ad as LoremModule, M as MetadataDefinition, l as MusicDefinition, ae as MusicModule, N as NumberColorFormat, af as NumberModule, P as PersonDefinition, m as PersonEntryDefinition, ah as PersonModule, aj as PhoneModule, n as PhoneNumberDefinition, S as ScienceDefinition, al as ScienceModule, ag as Sex, ai as SexType, Y as SimpleDateModule, ar as SimpleFaker, a7 as SimpleHelpersModule, K as StringColorFormat, an as StringModule, o as SystemDefinition, p as SystemMimeTypeEntryDefinition, ao as SystemModule, am as Unit, V as VehicleDefinition, ap as VehicleModule, W as WordDefinition, aq as WordModule, as as simpleFaker } from '@faker-js/faker/dist/airline-BLb3y-7w';
export { faker, faker as fakerEN } from '@faker-js/faker/locale/en';
export { faker as fakerAF_ZA } from '@faker-js/faker/locale/af_ZA';
export { faker as fakerAR } from '@faker-js/faker/locale/ar';
export { faker as fakerAZ } from '@faker-js/faker/locale/az';
export { faker as fakerBASE } from '@faker-js/faker/locale/base';
export { faker as fakerCS_CZ } from '@faker-js/faker/locale/cs_CZ';
export { faker as fakerDA } from '@faker-js/faker/locale/da';
export { faker as fakerDE } from '@faker-js/faker/locale/de';
export { faker as fakerDE_AT } from '@faker-js/faker/locale/de_AT';
export { faker as fakerDE_CH } from '@faker-js/faker/locale/de_CH';
export { faker as fakerDV } from '@faker-js/faker/locale/dv';
export { faker as fakerEL } from '@faker-js/faker/locale/el';
export { faker as fakerEN_AU } from '@faker-js/faker/locale/en_AU';
export { faker as fakerEN_AU_ocker } from '@faker-js/faker/locale/en_AU_ocker';
export { faker as fakerEN_BORK } from '@faker-js/faker/locale/en_BORK';
export { faker as fakerEN_CA } from '@faker-js/faker/locale/en_CA';
export { faker as fakerEN_GB } from '@faker-js/faker/locale/en_GB';
export { faker as fakerEN_GH } from '@faker-js/faker/locale/en_GH';
export { faker as fakerEN_HK } from '@faker-js/faker/locale/en_HK';
export { faker as fakerEN_IE } from '@faker-js/faker/locale/en_IE';
export { faker as fakerEN_IN } from '@faker-js/faker/locale/en_IN';
export { faker as fakerEN_NG } from '@faker-js/faker/locale/en_NG';
export { faker as fakerEN_US } from '@faker-js/faker/locale/en_US';
export { faker as fakerEN_ZA } from '@faker-js/faker/locale/en_ZA';
export { faker as fakerEO } from '@faker-js/faker/locale/eo';
export { faker as fakerES } from '@faker-js/faker/locale/es';
export { faker as fakerES_MX } from '@faker-js/faker/locale/es_MX';
export { faker as fakerFA } from '@faker-js/faker/locale/fa';
export { faker as fakerFI } from '@faker-js/faker/locale/fi';
export { faker as fakerFR } from '@faker-js/faker/locale/fr';
export { faker as fakerFR_BE } from '@faker-js/faker/locale/fr_BE';
export { faker as fakerFR_CA } from '@faker-js/faker/locale/fr_CA';
export { faker as fakerFR_CH } from '@faker-js/faker/locale/fr_CH';
export { faker as fakerFR_LU } from '@faker-js/faker/locale/fr_LU';
export { faker as fakerFR_SN } from '@faker-js/faker/locale/fr_SN';
export { faker as fakerHE } from '@faker-js/faker/locale/he';
export { faker as fakerHR } from '@faker-js/faker/locale/hr';
export { faker as fakerHU } from '@faker-js/faker/locale/hu';
export { faker as fakerHY } from '@faker-js/faker/locale/hy';
export { faker as fakerID_ID } from '@faker-js/faker/locale/id_ID';
export { faker as fakerIT } from '@faker-js/faker/locale/it';
export { faker as fakerJA } from '@faker-js/faker/locale/ja';
export { faker as fakerKA_GE } from '@faker-js/faker/locale/ka_GE';
export { faker as fakerKO } from '@faker-js/faker/locale/ko';
export { faker as fakerLV } from '@faker-js/faker/locale/lv';
export { faker as fakerMK } from '@faker-js/faker/locale/mk';
export { faker as fakerNB_NO } from '@faker-js/faker/locale/nb_NO';
export { faker as fakerNE } from '@faker-js/faker/locale/ne';
export { faker as fakerNL } from '@faker-js/faker/locale/nl';
export { faker as fakerNL_BE } from '@faker-js/faker/locale/nl_BE';
export { faker as fakerPL } from '@faker-js/faker/locale/pl';
export { faker as fakerPT_BR } from '@faker-js/faker/locale/pt_BR';
export { faker as fakerPT_PT } from '@faker-js/faker/locale/pt_PT';
export { faker as fakerRO } from '@faker-js/faker/locale/ro';
export { faker as fakerRO_MD } from '@faker-js/faker/locale/ro_MD';
export { faker as fakerRU } from '@faker-js/faker/locale/ru';
export { faker as fakerSK } from '@faker-js/faker/locale/sk';
export { faker as fakerSR_RS_latin } from '@faker-js/faker/locale/sr_RS_latin';
export { faker as fakerSV } from '@faker-js/faker/locale/sv';
export { faker as fakerTH } from '@faker-js/faker/locale/th';
export { faker as fakerTR } from '@faker-js/faker/locale/tr';
export { faker as fakerUK } from '@faker-js/faker/locale/uk';
export { faker as fakerUR } from '@faker-js/faker/locale/ur';
export { faker as fakerUZ_UZ_latin } from '@faker-js/faker/locale/uz_UZ_latin';
export { faker as fakerVI } from '@faker-js/faker/locale/vi';
export { faker as fakerYO_NG } from '@faker-js/faker/locale/yo_NG';
export { faker as fakerZH_CN } from '@faker-js/faker/locale/zh_CN';
export { faker as fakerZH_TW } from '@faker-js/faker/locale/zh_TW';
export { faker as fakerZU_ZA } from '@faker-js/faker/locale/zu_ZA';
